			...
			<div class="entry-content">
				...
				<div class="entry-meta site-secondary-font">
					...
					<div class="entry-meta__item entry-meta-author">
						...
						<?php esc_html_e( '<span>on</span> ', 'juliette' );?><?php echo nova_posted_on(); ?>

					</div>

					<div class="entry-meta__item entry-meta_post_comments">
						<?php if ( comments_open() ) : ?>
							<i class="juliette-icons-chat_chat-15"></i>
							<a href="#comments">
				...
				<?php
				wp_link_pages( array(
					'before' => '<div class="page-links">' . wp_kses(__( '<span class="pages">Pages:</span>', 'juliette' ),'simple'),
					'after'  => '</div>',
					'link_before' => '<span>',
					'link_after'  => '</span>',
				) );
				...
				<div class="entry-tags">
					<div class="entry-meta__item entry-meta__item--tags site-secondary-font">
						<?php the_tags(wp_kses(__('<span>Tags</span>', 'juliette'),'simple'), '', ''); ?>
					</div>
				</div>
