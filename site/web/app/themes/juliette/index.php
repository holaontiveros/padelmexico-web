				...
				<div class="cell small-12 <?php echo ( 1 == Nova_OP::getOption('blog_sidebar') && is_active_sidebar( 'blog-widget-area' ) ) ? 'large-9' : 'large-12' ?> site-main-content-wrapper">
					<div class="site-main-content">
								...
								if ( have_posts() ) {
									if ( ! function_exists( 'elementor_theme_do_location' ) || ! elementor_theme_do_location( 'archive' ) ) {
										if( 'layout-4' == Nova_OP::getOption('blog_layout') || 'layout-2' == Nova_OP::getOption('blog_layout') ) {
											echo '<div class="grid-x grid-padding-x grid-padding-y large-up-'.esc_attr( $column_l ).' medium-up-'.esc_attr( $column_m ).' small-up-'.esc_attr( $column_s ).'">';
										}
						...
						the_posts_navigation(array(
							'prev_text' => esc_html__( 'Older posts', 'juliette' ),
							'next_text' => esc_html__( 'Newer posts', 'juliette' ),
						));
						?>
