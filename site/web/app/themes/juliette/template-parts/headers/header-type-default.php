...
if('on' == Nova_OP::getOption('header_wide')) {
 ...
 ?>
<header id="masthead" class="nova-header header-type-default <?php echo esc_attr($header_class) ?> logo-center headroom">
	<div class="<?php echo esc_attr($header_wide)?> align-middle">
		<div class="header-left-items header-items has-menu">
			<?php if ( Nova_OP::getOption('header_burger_menu') == 1 && defined('SF_VERSION_NUM') ) : ?>
				<a id="js_juliette_burger_menu" class="juliette_burger_menu">
		...
		<?php
		if ( class_exists( 'Nova_Mega_Menu_Walker' ) ) {
			echo '<nav class="main-navigation header-secondary-nav">';
			wp_nav_menu(array(
				'theme_location'    => 'nova_menu_secondary',
				'container'         => false,
				'menu_class'        => 'menu nav-menu',
				'link_before'       => '',
				'link_after'        => '',
