<div id="novamm-panel-settings" class="novamm-panel-settings novamm-panel">
	...
	<table class="form-table">
		<tr class="item-visible-fields">
			<th scope="row"><?php esc_html_e( 'Visibility', 'nova-addons' ) ?></th>
			<td>
				<label>
					...
					<?php esc_html_e( 'Visible', 'nova-addons' ) ?>
				</label>
				&nbsp;
				<label>
					...
					<?php esc_html_e( 'Hidden', 'nova-addons' ) ?>
				</label>
				&nbsp;
				<label>
					...
					<?php esc_html_e( 'Soft hidden (keep spacing)', 'nova-addons' ) ?>
				</label>
			</td>
		</tr>

		<tr class="item-link-field" style="{{ 'visible' !== data.megaData.visible ? 'display:none' : '' }}">
			<th scope="row"><?php esc_html_e( 'Disable link', 'nova-addons' ) ?></th>
			<td>
				<label>
					...
					<?php esc_html_e( 'Disable menu item link', 'nova-addons' ) ?>
				</label>
			</td>
		</tr>
	</table>
