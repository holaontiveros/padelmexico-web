<div id="novamm-panel-mega" class="novamm-panel-mega novamm-panel">
	<p class="mega-settings">
		<span class="setting-field">
			<label>
				<?php esc_html_e( 'Enable mega menu', 'nova-addons' ) ?><br>
				<select name="{{ novamm.getFieldName( 'mega', data.data['menu-item-db-id'] ) }}">
					<option value="0"><?php esc_html_e( 'No', 'nova-addons' ) ?></option>
					<option value="1" {{ parseInt( data.megaData.mega ) ? 'selected="selected"' : '' }}><?php esc_html_e( 'Yes', 'nova-addons' ) ?></option>
				</select>
			</label>
		</span>
		...
		<span class="setting-field novamm-mega-width-field">
			<label>
				<?php esc_html_e( 'Container width', 'nova-addons' ) ?><br>
				<select name="{{ novamm.getFieldName( 'width', data.data['menu-item-db-id'] ) }}">
					<option value="container"><?php esc_html_e( 'Default', 'nova-addons' ) ?></option>
					<option value="container-fluid" {{ 'container-fluid' == data.megaData.width ? 'selected="selected"' : '' }}><?php esc_html_e( 'Fluid', 'nova-addons' ) ?></option>
					<option value="custom" {{ 'custom' == data.megaData.width ? 'selected="selected"' : '' }}><?php esc_html_e( 'Custom', 'nova-addons' ) ?></option>
				</select>
			</label>
		</span>
		...
		<span class="setting-field" style="{{ 'custom' == data.megaData.width ? '' : 'display: none;' }}">
			<label>
				<?php esc_html_e( 'Custom width', 'nova-addons' ) ?><br>
