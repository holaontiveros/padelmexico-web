...
class Advanced_Carousel extends NOVA_Widget_Base {
    ...
    public function get_loop_image_item() {
        ...
        if(!empty($image_data)){
            ...
            return sprintf( apply_filters('NovaworksElement/adv-images-layout/image-format', '<img src="%1$s" data-src="%2$s" alt="" class="nova-lazyload-image %3$s" %4$s>'), $giflazy, $image_data[0], 'novaworks-images-layout__image-instance' , $srcset);
        }
