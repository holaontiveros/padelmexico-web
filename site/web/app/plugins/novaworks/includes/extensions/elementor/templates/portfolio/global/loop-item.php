...
$term_obj = get_the_terms(get_the_ID(), 'nova_portfolio_category');
$slug_list = array('all');
$cat_list = array();
                ...
                <div class="novaworks-portfolio__content-inner2"><?php
                    ...
                    if( $this->get_settings_for_display('show_readmore_btn') ) {
                        ...
                        if($preset == 'list-type-2' || $preset == 'type-6' || $preset == 'type-7'){
                            ...
                            $btn_attr = 'class="novaworks-portfolio__button button js-el" data-nova_component="SVGAnimation" data-hover="yes"';
                        }
