    ...
    protected function product_loop() {
        ...
        if( $layout == 'grid' ){
            if( 'yes' == $this->settings['carousel_enabled'] ) {
                ...
                $loopCssClass[] = 'novaworks-carousel slick-carousel js-el nova-slick-slider';
            }
        }
        ...
        if(!$in_elementor && $is_ajax_load_first && !isset($_GET[$paged_key])){
            ...
            $ajax_html_first = '<div class="js-el ' . esc_attr( implode( ' ', $wrapper_classes ) ) . '" data-nova_component="InfiniteScroll" data-pagination=".elementor_wc_widget_'.$this->unique_id.' .nova-pagination">';
