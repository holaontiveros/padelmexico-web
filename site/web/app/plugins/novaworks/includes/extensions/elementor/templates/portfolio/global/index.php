...
if('masonry' == $layout){
    ...
    if(!empty($settings['enable_custom_masonry_layout'])){
        $this->add_render_attribute( 'list-container', 'data-nova_component', 'AdvancedMasonry');
        ...
        $this->add_render_attribute( 'list-container', 'data-nova_component', 'DefaultMasonry');
        $this->add_render_attribute( 'list-container', 'class', array(
            'grid-items',
            'block-grid-' . $columns,
...
if( 'grid' == $layout || 'list' == $layout ) {
    ...
    if(!empty($slider_options)){
        ...
        $this->add_render_attribute( 'list-container', 'data-nova_component', 'AutoCarousel');
    }
}
