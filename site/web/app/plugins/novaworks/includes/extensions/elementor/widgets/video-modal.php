...
class Video_Modal extends NOVA_Widget_Base {
    ...
    public function get_style_depends() {
        return ['novaworks-video-modal-elm'];
    }
     ...
     */
     protected function render() {
        ...
        if($video_url['url']) {
          echo '<div class="nova-video-modal"><a data-video-url="'.$video_url['url'].'" class="js-video-popup-btn video-modal-btn">'.$play_icon.'</a></div>';
        }
     }
