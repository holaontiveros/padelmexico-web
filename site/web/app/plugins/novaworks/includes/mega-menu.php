...
class Nova_Addons_Waler_Mega_Menu_Edit extends Walker_Nav_Menu_Edit {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( $cancel ) {
			...
			$link->nodeValue = esc_html__( 'Settings', 'nova-addons' );
		...
		<div id="novamm-mega-menu" tabindex="0" class="novamm-mega-menu">
			<div class="novamm-modal media-modal wp-core-ui">
				<button type="button" class="button-link media-modal-close novamm-modal-close">
					<span class="media-modal-icon"><span class="screen-reader-text"><?php esc_html_e( 'Close', 'nova-addons' ) ?></span></span>
				</button>
					...
					<div class="novamm-frame-toolbar media-frame-toolbar">
						<div class="novamm-toolbar media-toolbar">
							<div class="novamm-toolbar-primary media-toolbar-primary search-form">
								<button type="button" class="button novamm-button-save media-button button-primary button-large"><?php esc_html_e( 'Save Changes', 'nova-addons' ) ?></button>
								<button type="button" class="button novamm-button-cancel media-button button-secondary button-large"><?php esc_html_e( 'Cancel', 'nova-addons' ) ?></button>
